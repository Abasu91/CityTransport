...
<html>
    ...
    <body>
        ...
        Class.forName("oracle.jdbc.driver.OracleDriver");
                 ...
                 String busno=request.getParameter("o4");
                 String fare=request.getParameter("o5");
                 
                 Statement st=con.createStatement();
                 int p =st.executeUpdate(" delete from interbus_details where src='"+source+"' and dest='"+destination+"' and type='"+type+"' and BusNumber="+busno+" and fare='"+fare+"' ");
